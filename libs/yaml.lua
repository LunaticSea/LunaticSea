--[[lit-meta
    name = "LunaticSea/yaml"
    version = "0.1.0"
    dependencies = {}
    description = "A yaml encoder and decoder"
    tags = { "yaml", "parser" }
    license = "MIT"
    author = { name = "LunaticSea", email = "/" }
    homepage = "https://github.com/LunaticSea/LunaticSea/blob/master/libs/yaml.lua"
  ]]
